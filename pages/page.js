  ...
  return (
    <>
      <div className="page-container1">
        <Head>
          <title>Page - Prime Pathology Clinic</title>
          <meta property="og:title" content="Page - Prime Pathology Clinic" />
          <meta
          ...
          />
          <link rel="canonical" href="https://patho.teleporthq.site/page" />
          <meta
            property="og:url"
            content="https://patho.teleporthq.site/page"
          />
        </Head>
  ...
  transition: none;
          ...
          <div className="hero-section__content">
            ...
            <div className="hero-section__cta-row">
              ...
              <a href="#services-carousel">
                <div className="hero-section__btn-ghost btn btn-outline">
        ...
        <section aria-labelledby="intro-heading" className="intro-section">
          <div className="intro-section__inner">
            ...
            <div className="intro-section__text-col">
              ...
              <h2
                id="intro-heading"
                className="intro-section__heading section-title"
              >
              ...
              <a href="#application-form">
                <div className="intro-section__cta btn btn-primary">
        ...
        >
          <div className="approach-section__inner">
            <div className="approach-section__text-col">
              ...
              <h2
                id="approach-heading"
                className="approach-section__heading section-title"
              >
            ...
            <div aria-hidden="true" className="approach-section__visual-col">
              <div className="approach-lab-viz">
                ...
                <div className="approach-lab-viz__orbit approach-lab-viz__orbit--1">
                ...
                <div className="approach-lab-viz__orbit approach-lab-viz__orbit--2">
        ...
        <section aria-labelledby="why-heading" className="why-section">
          <div className="why-section__inner">
            <div className="why-section__header">
              ...
              <h2 id="why-heading" className="why-section__title section-title">
                Why You Should Engage Us
              </h2>
              <p className="why-section__subtitle section-content">
            ...
            <div className="why-section__cards">
              ...
              <article
                ...
                className="page-why-card why-card--featured"
              >
                <div className="why-card__icon-wrap">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
        ...
        >
          <div className="services-section__inner">
            <div className="services-section__header">
              ...
              <h2
                id="services-heading"
                className="services-section__title section-title"
              >
                Our Core Services
              </h2>
              ...
              >
                ...
                >
                  <button
                    ...
                    className="services-carousel__dot services-carousel__dot--active"
                  ></button>
                  <button
        ...
        <section aria-labelledby="who-heading" className="who-section">
          <div className="who-section__inner">
            <div className="who-section__header">
              ...
              <h2 id="who-heading" className="who-section__title section-title">
                Who Is It For?
              </h2>
        ...
        <section aria-labelledby="deliver-heading" className="deliver-section">
          <div className="deliver-section__inner">
            <div className="deliver-section__header">
              ...
              <h2
                id="deliver-heading"
                className="deliver-section__title section-title"
              >
                How We Deliver Care
              </h2>
          ...
          <div className="equipment-section__inner">
            <div className="equipment-section__header">
              ...
              <h2
                ...
                className="equipment-section__title section-title"
              >
            ...
            <div className="page-equipment-grid1">
              <article
                ...
                className="page-equipment-card equipment-card--large"
              >
                <img
        ...
        >
          <div className="team-section__inner">
            ...
            <div className="page-team-grid team-grid">
              <article
        ...
        <section
          ...
          className="page-timeline-section timeline-section"
        >
          <div className="timeline-section__inner">
            <div className="timeline-section__header">
              ...
              <h2
                id="timeline-heading"
                className="timeline-section__title section-title"
              >
                Process Timeline
              </h2>
        ...
        >
          ...
          <div className="warroom-section__content">
            ...
            <h2
              id="warroom-heading"
              className="warroom-section__title section-title"
            >
            ...
            <div className="warroom-section__gallery">
              ...
              <div className="warroom-gallery-item warroom-gallery-item--wide">
                <img
        ...
        >
          <div className="application-section__inner">
            <div className="application-section__header">
              ...
              <h2
                id="form-heading"
                className="application-section__title section-title"
              >
              ...
              >
                ...
                <div className="application-form__row">
                  ...
                  <div className="application-form__group">
                    ...
                    <select
                      ...
                      className="application-form__input application-form__select"
                    >
                ...
                <div className="application-form__submit-row">
                  <button
                    ...
                    className="application-form__submit btn btn-accent btn-lg"
                  >
                    Submit Application
                  </button>
                </div>
        ...
        <section aria-labelledby="map-heading" className="map-section">
          <div className="map-section__inner">
            <div className="map-section__header">
              ...
              <h2 id="map-heading" className="map-section__title section-title">
        ...
        <section aria-labelledby="cert-heading" className="cert-section">
          <div className="cert-section__inner">
            <div className="cert-section__header">
              ...
              <h2
                id="cert-heading"
                className="cert-section__title section-title"
              >

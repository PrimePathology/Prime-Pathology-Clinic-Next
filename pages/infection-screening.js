...
const InfectionScreening = (props) => {
  return (
    <>
      <div className="infection-screening-container10">
        <Head>
          <title>Infection-Screening - Prime Pathology Clinic</title>
          <meta
            property="og:title"
            content="Infection-Screening - Prime Pathology Clinic"
          />
          <meta
          ...
          <link
            rel="canonical"
            href="https://patho.teleporthq.site/infection-screening"
          />
          <meta
            property="og:url"
            content="https://patho.teleporthq.site/infection-screening"
          />
        </Head>
        <Navigation></Navigation>
        <div className="infection-screening-container11">
          <div className="infection-screening-container12">
            <Script
              html={`<style>
section {
  position: relative;
...
details[open] summary::after {
  content: '−';
        ...
        <div className="infection-screening-container21">
          <div className="infection-screening-container22">
            <Script
              html={`<style>
...
transform: translateY(0);}}
        ...
        <div className="infection-screening-container23">
          <div className="infection-screening-container24">
            <Script
...
if (bookingForm) {
  bookingForm.addEventListener('submit', (e) => {
    ...
    btn.style.opacity = '0.7';
      ...
      <style jsx>
        {`
          .infection-screening-container10 {
            width: 100%;
            min-height: 100vh;
          }
          .infection-screening-container11 {
            display: none;
          }
          .infection-screening-container12 {
            display: contents;
          }
          .infection-screening-container21 {
            display: none;
          }
          .infection-screening-container22 {
            display: contents;
          }
          .infection-screening-container23 {
            display: none;
          }
          .infection-screening-container24 {
            display: contents;
          }
        `}
      </style>
...
export default InfectionScreening

  ...
  return (
    <>
      <div className="terms-of-service-container1">
        <Head>
          <title>Terms-of-Service - Prime Pathology Clinic</title>
          <meta
            property="og:title"
            content="Terms-of-Service - Prime Pathology Clinic"
          />
          <meta
          ...
          <link
            rel="canonical"
            href="https://patho.teleporthq.site/terms-of-service"
          />
          <meta
            property="og:url"
            content="https://patho.teleporthq.site/terms-of-service"
          />
        </Head>
          ...
          <div className="approach-container">
            ...
            <div className="page-approach-visual">
              <div className="workflow-animation">
                <div className="terms-of-service-thq-workflow-node-elm1 workflow-node"></div>
                <div className="terms-of-service-thq-workflow-node-elm2 workflow-node"></div>
                <div className="terms-of-service-thq-workflow-node-elm3 workflow-node"></div>
    ...
    observer.observe(el)
      ...
      <style jsx>
        {`
          ...
          .terms-of-service-thq-workflow-node-elm1 {
            top: 10%;
            left: 10%;
          }
          .terms-of-service-thq-workflow-node-elm2 {
            top: 50%;
            left: 80%;
          }
          .terms-of-service-thq-workflow-node-elm3 {
            top: 80%;
            left: 30%;
          }
